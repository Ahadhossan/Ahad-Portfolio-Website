...
//   return (
//     <div className="h-full mt-16 mx-auto bg-[#FAFAFA] font-sans antialiased max-w-7xl px-4 sm:px-6 md:px-12 lg:px-[3vw]">
...
const Contact = () => {
  ...
  return (
    <div className="h-full mt-16 mx-auto max-w-7xl bg-[#FAFAFA] font-sans antialiased px-4 sm:px-6 md:px-12 lg:px-[3vw]">
      <div className="grid grid-cols-1 md:grid-cols-5">
        {/* Left panel: intro + contact details */}
        <div className="flex flex-col justify-between border-b border-slate-200 p-8 md:col-span-2 md:border-b-0 md:border-r md:p-14">
          <div>
